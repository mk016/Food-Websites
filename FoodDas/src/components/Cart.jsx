  ...
  return (
    <div class=" flex justify-center items-center w-full min-h-screen" style={{ backgroundColor: '#FFEFE6' }}>
        ...
        <div className='w-1/3 pl-6  text-white rounded-lg p-6' style={{ backgroundColor :'#FF6000'}}>
          ...
          <img src={Dosha} alt='img' className='rounded-full bg-white h-20 w-20 2xl:items-center' />
          </div>
          ...
          <div className='mb-4'>
            ...
            <input className=' rounded w-full py-2 px-3' placeholder='1111 2222 3333 4444' />
          </div>
